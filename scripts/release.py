...
AUTHOR_MAP = {
    # hermes-fork: keep fork author entries below (union with upstream's new contributors)
    ...
    # hermes-fork: 2026-07-15 sync — new upstream contributors (mapped via commit→PR author)
    "agent@agents-Mac-mini.local": "momomojo",  # PR salvage (kanban goal_mode -Q; unlinked local identity)
    "gigakun@agentmail.to": "gigakun3030",  # PR #61163 (remove unavailable OpenCode Zen free models)
    "git@hode.co.uk": "OutThisLife",  # PR salvage (react-streamdown docs/fixtures; commit by Harry Yep)
    "jakub.wolniewicz@gmail.com": "frizikk",  # PR salvage (dismiss stale prompt overlays)
    "markvlcek@gmail.com": "teknium1",  # PR salvage (Fallback Models editor; no linked GH account)
