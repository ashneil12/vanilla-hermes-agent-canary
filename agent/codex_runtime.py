...
# hermes-fork: stream-state resilience — synthesize a completed response when
# the SDK's terminal parser crashes on nullable event fields after content
# already streamed. Still called from run_codex_stream below.
