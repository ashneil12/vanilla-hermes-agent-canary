...
async def get_status(profile: Optional[str] = None):
    ...
    try:
        ...
        status = {
            ...
            # HermesOS: control-plane dashboard origin (HERMES_DASHBOARD_URL).
            # Used by rich chat to deep-link to managed-Venice enable/deposit flow.
    ...
    try:
        ...
        with _profile_scope(profile):
            return build_models_payload(
                ...
                # this stays cheap.) include_unconfigured is caller-controlled
                # per upstream #56974; the fork web client opts in explicitly.
                max_models=1000,
