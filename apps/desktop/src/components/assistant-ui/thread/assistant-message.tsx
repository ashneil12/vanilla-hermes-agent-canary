    ...
    <div className="relative flex w-full shrink-0 justify-end">
      <ActionBarPrimitive.Root
        className={
          ...
          // hermes-fork: touch: variants keep the action bar reachable on
          // touch devices (no hover). menuOpen arm dropped — upstream removed it.
          'relative flex flex-row items-center justify-end gap-1.5 py-1.5 opacity-0 pointer-events-none group-hover:pointer-events-auto group-hover:opacity-100 focus-within:pointer-events-auto focus-within:opacity-100 touch:pointer-events-auto touch:opacity-100'
        }
