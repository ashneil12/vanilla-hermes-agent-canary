...
// hermes-fork: Dashboard → iframe bridge: the embedding dashboard postMessages
// this type to inject a starter prompt as a user message (parallels the
// appearance message in themes/context.tsx). Powers the dashboard welcome
// starter-prompt strip.
