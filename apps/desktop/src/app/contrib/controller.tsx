...
export function ContribController() {
  ...
  return (
    <SidebarProvider
      // hermes-fork: dvh, not vh — mobile Safari's 100vh is the LARGE viewport,
      // which pushes the statusbar/composer under the browser toolbar. Desktop
      // is identical. (Carried over from the retired app-shell.tsx patch.)
