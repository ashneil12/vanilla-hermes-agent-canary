...
export type SidebarNavId =
  'admin-panel' | 'artifacts' | 'command-center' | 'cron' | 'messaging' | 'new-session' | 'settings' | 'skills'
...
export interface SidebarNavItem {
  ...
  route?: string
  // hermes-fork: 'admin-panel' is a HermesOS web-only add-on: opens the full
  // dashboard (telemetry / config / channels / TUI chat) at /dash in a new tab.
