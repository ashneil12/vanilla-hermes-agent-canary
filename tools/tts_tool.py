...
# hermes-fork: Venice TTS defaults (one VENICE_API_KEY covers chat+image+video+speech).
...
# hermes-fork: graceful Venice auto-pair + local-unavailable fallback.
...
def _get_provider(tts_config: Dict[str, Any]) -> str:
    ...
    hermes-fork (case D vs upstream): upstream requires explicit tts.provider
    for cloud TTS (credentials != consent). On HermesOS-managed boxes the
    Venice key is the platform multimodal key, so auto-pair stays.
...
# ===========================================================================
# Provider: Venice TTS  (hermes-fork)
# ===========================================================================
...
def _text_to_speech_single(
    ...
    *,
    ...
    try:
        ...
        elif provider == "venice":  # hermes-fork
