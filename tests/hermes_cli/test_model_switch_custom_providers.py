...
# --- provider_has_resolvable_credentials credential guard (folded in from a
# standalone file: net-new test files are wiped by shard (3)'s checkout reset) ---
#
...
# …bricking chat until config.yaml was fixed out-of-band. switch_model (and the
# REST config-write paths) now refuse to persist a provider whose credentials
# can't be resolved, leaving the working config intact.
