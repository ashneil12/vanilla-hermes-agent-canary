...
class TestCodexOAuthContextLength:
    ...
    def setup_method(self):
        ...
        # hermes-fork: reset the negative-cache backoff alongside upstream's
        # positive-cache reset — a probe failure in one test must not suppress
        # probes in the next (same module-state hygiene as the line above).
