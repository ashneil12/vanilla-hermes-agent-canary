...
class TestGetToolset:
    ...
    def test_merges_registry_tools_into_builtin_toolset(self, monkeypatch):
        ...
        ts = get_toolset("web")
        assert ts is not None
        assert set(ts["tools"]) == {"web_search", "web_extract", "text_parser", "video_transcribe", "web_search_plus"}
...
class TestResolveToolset:
    def test_leaf_toolset(self):
        ...
        assert set(tools) == {"web_search", "web_extract", "text_parser", "video_transcribe"}
